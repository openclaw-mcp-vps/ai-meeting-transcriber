...
ARCHITECTURE SPEC:
Next.js app with file upload/URL input, Whisper API transcription, Claude API for action item extraction and sentiment analysis. Lemon Squeezy handles payments with usage tracking via database.
...
DEPENDENCIES: next, react, tailwindcss, prisma, @prisma/client, openai, @anthropic-ai/sdk, @lemonsqueezy/lemonsqueezy.js, uploadthing, ffmpeg-static, fluent-ffmpeg, stripe
